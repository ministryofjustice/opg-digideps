...
up-app-xdebug: ##@application Brings the app up, rebuilds containers and enabled xdebug in client
	REQUIRE_XDEBUG_API=1 REQUIRE_XDEBUG_FRONTEND=1 docker-compose up -d --build --remove-orphans
