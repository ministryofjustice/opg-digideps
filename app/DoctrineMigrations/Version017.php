...
/**
 *new account transaction tables
 */
class Version017 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE account_transaction (id INT NOT NULL, account_id INT DEFAULT NULL, account_transaction_type_id VARCHAR(255) DEFAULT NULL, amount NUMERIC(14, 2) NOT NULL, moreDetails TEXT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE account_transaction_type (id VARCHAR(255) NOT NULL, has_more_details BOOLEAN NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE account_transaction_type ADD display_order INT DEFAULT NULL');
    }
