 ...
 */
class Version157 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
       ...
       $this->addSql('CREATE SEQUENCE money_transfer_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE ndr_income_state_benefit (id SERIAL NOT NULL, ndr_id INT DEFAULT NULL, type_id VARCHAR(255) NOT NULL, present BOOLEAN DEFAULT NULL, has_more_details VARCHAR(255) NOT NULL, more_details VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1C1A04A77CE4B994 ON ndr_income_state_benefit (ndr_id)');
        $this->addSql('CREATE TABLE ndr_asset (id SERIAL NOT NULL, ndr_id INT DEFAULT NULL, asset_value NUMERIC(14, 2) DEFAULT NULL, last_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, type VARCHAR(255) NOT NULL, address VARCHAR(200) DEFAULT NULL, address2 VARCHAR(200) DEFAULT NULL, county VARCHAR(75) DEFAULT NULL, postcode VARCHAR(10) DEFAULT NULL, occupants VARCHAR(550) DEFAULT NULL, owned VARCHAR(15) DEFAULT NULL, owned_percentage NUMERIC(14, 2) DEFAULT NULL, is_subject_equity_rel VARCHAR(4) DEFAULT NULL, has_mortgage VARCHAR(4) DEFAULT NULL, mortgage_outstanding NUMERIC(14, 2) DEFAULT NULL, has_charges VARCHAR(4) DEFAULT NULL, is_rented_out VARCHAR(4) DEFAULT NULL, rent_agreement_end_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, rent_income_month NUMERIC(14, 2) DEFAULT NULL, title VARCHAR(100) DEFAULT NULL, description TEXT DEFAULT NULL, valuation_date DATE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_73D022FB7CE4B994 ON ndr_asset (ndr_id)');
        $this->addSql('CREATE TABLE ndr_debt (id SERIAL NOT NULL, ndr_id INT DEFAULT NULL, debt_type_id VARCHAR(255) NOT NULL, amount NUMERIC(14, 2) DEFAULT NULL, has_more_details BOOLEAN NOT NULL, more_details TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_154224C77CE4B994 ON ndr_debt (ndr_id)');
        $this->addSql('CREATE TABLE ndr_expense (id SERIAL NOT NULL, ndr_id INT DEFAULT NULL, explanation TEXT NOT NULL, amount NUMERIC(14, 2) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_92A22FF97CE4B994 ON ndr_expense (ndr_id)');
        $this->addSql('CREATE TABLE ndr_income_one_off (id SERIAL NOT NULL, ndr_id INT DEFAULT NULL, type_id VARCHAR(255) NOT NULL, present BOOLEAN DEFAULT NULL, has_more_details VARCHAR(255) NOT NULL, more_details VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5941831F7CE4B994 ON ndr_income_one_off (ndr_id)');
        $this->addSql('CREATE TABLE ndr_visits_care (id SERIAL NOT NULL, ndr_id INT DEFAULT NULL, plan_move_residence VARCHAR(4) DEFAULT NULL, plan_move_residence_details TEXT DEFAULT NULL, do_you_live_with_client VARCHAR(4) DEFAULT NULL, how_often_contact_client TEXT DEFAULT NULL, does_client_receive_paid_care TEXT DEFAULT NULL, how_is_care_funded VARCHAR(255) DEFAULT NULL, who_is_doing_the_caring TEXT DEFAULT NULL, does_client_have_a_care_plan VARCHAR(4) DEFAULT NULL, when_was_care_plan_last_reviewed DATE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9239DE877CE4B994 ON ndr_visits_care (ndr_id)');
        $this->addSql('CREATE TABLE ndr_account (id SERIAL NOT NULL, ndr_id INT DEFAULT NULL, bank_name VARCHAR(500) DEFAULT NULL, account_type VARCHAR(125) DEFAULT NULL, sort_code VARCHAR(6) DEFAULT NULL, account_number VARCHAR(4) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, balance_on_cod NUMERIC(14, 2) DEFAULT NULL, is_joint_account VARCHAR(3) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C2AEF4FB7CE4B994 ON ndr_account (ndr_id)');
        $this->addSql('CREATE TABLE ndr (id SERIAL NOT NULL, client_id INT DEFAULT NULL, has_debts VARCHAR(5) DEFAULT NULL, no_asset_to_add BOOLEAN DEFAULT \'false\', submitted BOOLEAN DEFAULT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, submit_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, agreed_behalf_deputy VARCHAR(50) DEFAULT NULL, agreed_behalf_deputy_explanation TEXT DEFAULT NULL, receive_state_pension TEXT DEFAULT NULL, receive_other_income TEXT DEFAULT NULL, receive_other_income_details TEXT DEFAULT NULL, expect_compensation_damages TEXT DEFAULT NULL, expect_compensation_damages_details TEXT DEFAULT NULL, paid_for_anything VARCHAR(3) DEFAULT NULL, action_give_gifts_to_client VARCHAR(3) DEFAULT NULL, action_give_gifts_to_client_details TEXT DEFAULT NULL, action_property_maintenance VARCHAR(3) DEFAULT NULL, action_property_selling_rent VARCHAR(3) DEFAULT NULL, action_property_buy VARCHAR(3) DEFAULT NULL, action_more_info VARCHAR(3) DEFAULT NULL, action_more_info_details TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_350EBBC19EB6921 ON ndr (client_id)');
        ...
        $this->addSql('CREATE TABLE casrec (id SERIAL NOT NULL, client_case_number VARCHAR(20) NOT NULL, client_lastname VARCHAR(50) NOT NULL, deputy_no VARCHAR(100) NOT NULL, deputy_lastname VARCHAR(100) DEFAULT NULL, deputy_postcode VARCHAR(10) DEFAULT NULL, type_of_report VARCHAR(10) DEFAULT NULL, corref VARCHAR(10) DEFAULT NULL, other_columns TEXT DEFAULT NULL, uploaded_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, registration_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_logged_in TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, reports_submitted VARCHAR(4) DEFAULT NULL, last_report_submitted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, reports_active VARCHAR(4) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE report_submission (id SERIAL NOT NULL, report_id INT DEFAULT NULL, archived_by INT DEFAULT NULL, created_by INT DEFAULT NULL, downloadable BOOLEAN DEFAULT \'true\' NOT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE report (id SERIAL NOT NULL, client_id INT DEFAULT NULL, submitted_by INT DEFAULT NULL, type VARCHAR(10) NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, submit_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, submitted BOOLEAN DEFAULT NULL, report_seen BOOLEAN DEFAULT \'true\' NOT NULL, agreed_behalf_deputy VARCHAR(50) DEFAULT NULL, agreed_behalf_deputy_explanation TEXT DEFAULT NULL, metadata TEXT DEFAULT NULL, wish_to_provide_documentation VARCHAR(255) DEFAULT NULL, no_asset_to_add BOOLEAN DEFAULT \'false\', balance_mismatch_explanation TEXT DEFAULT NULL, reason_for_no_contacts TEXT DEFAULT NULL, reason_for_no_decisions TEXT DEFAULT NULL, reason_for_no_fees TEXT DEFAULT NULL, paid_for_anything VARCHAR(3) DEFAULT NULL, gifts_exist VARCHAR(3) DEFAULT NULL, money_transactions_short_in_exist VARCHAR(3) DEFAULT NULL, money_transactions_short_out_exist VARCHAR(3) DEFAULT NULL, no_transfers_to_add BOOLEAN DEFAULT \'false\', action_more_info VARCHAR(3) DEFAULT NULL, action_more_info_details TEXT DEFAULT NULL, has_debts VARCHAR(5) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE ndr_income_state_benefit ADD CONSTRAINT FK_1C1A04A77CE4B994 FOREIGN KEY (ndr_id) REFERENCES ndr (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ndr_asset ADD CONSTRAINT FK_73D022FB7CE4B994 FOREIGN KEY (ndr_id) REFERENCES ndr (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ndr_debt ADD CONSTRAINT FK_154224C77CE4B994 FOREIGN KEY (ndr_id) REFERENCES ndr (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ndr_expense ADD CONSTRAINT FK_92A22FF97CE4B994 FOREIGN KEY (ndr_id) REFERENCES ndr (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ndr_income_one_off ADD CONSTRAINT FK_5941831F7CE4B994 FOREIGN KEY (ndr_id) REFERENCES ndr (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ndr_visits_care ADD CONSTRAINT FK_9239DE877CE4B994 FOREIGN KEY (ndr_id) REFERENCES ndr (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ndr_account ADD CONSTRAINT FK_C2AEF4FB7CE4B994 FOREIGN KEY (ndr_id) REFERENCES ndr (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ndr ADD CONSTRAINT FK_350EBBC19EB6921 FOREIGN KEY (client_id) REFERENCES client (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ndr_income_state_benefit DROP CONSTRAINT FK_1C1A04A77CE4B994');
        $this->addSql('ALTER TABLE ndr_asset DROP CONSTRAINT FK_73D022FB7CE4B994');
        $this->addSql('ALTER TABLE ndr_debt DROP CONSTRAINT FK_154224C77CE4B994');
        $this->addSql('ALTER TABLE ndr_expense DROP CONSTRAINT FK_92A22FF97CE4B994');
        $this->addSql('ALTER TABLE ndr_income_one_off DROP CONSTRAINT FK_5941831F7CE4B994');
        $this->addSql('ALTER TABLE ndr_visits_care DROP CONSTRAINT FK_9239DE877CE4B994');
        $this->addSql('ALTER TABLE ndr_account DROP CONSTRAINT FK_C2AEF4FB7CE4B994');
        ...
        $this->addSql('ALTER TABLE report_submission DROP CONSTRAINT FK_C84776C851B07D6D');
        ...
        $this->addSql('ALTER TABLE fee DROP CONSTRAINT FK_964964B54BD2A4C0');
        ...
        $this->addSql('ALTER TABLE report_submission DROP CONSTRAINT FK_C84776C84BD2A4C0');
        ...
        $this->addSql('ALTER TABLE ndr DROP CONSTRAINT FK_350EBBC19EB6921');
        ...
        $this->addSql('DROP TABLE ndr_income_state_benefit');
        $this->addSql('DROP TABLE ndr_asset');
        $this->addSql('DROP TABLE ndr_debt');
        $this->addSql('DROP TABLE ndr_expense');
        $this->addSql('DROP TABLE ndr_income_one_off');
        $this->addSql('DROP TABLE ndr_visits_care');
        $this->addSql('DROP TABLE ndr_account');
        $this->addSql('DROP TABLE ndr');
