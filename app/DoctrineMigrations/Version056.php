...
class Version056 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE concern (id SERIAL NOT NULL, report_id INT DEFAULT NULL, do_you_expect_decisions TEXT DEFAULT NULL, do_you_have_concerns TEXT DEFAULT NULL, PRIMARY KEY(id))');
