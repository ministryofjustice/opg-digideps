...
class Version136 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE note (id SERIAL NOT NULL, report_id INT DEFAULT NULL, created_by INT DEFAULT NULL, last_modified_by INT DEFAULT NULL, category VARCHAR(100) NOT NULL, title VARCHAR(150) NOT NULL, content TEXT NOT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_modified_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX ix_note_report_id ON note (report_id)');
        ...
        $this->addSql('ALTER TABLE note ADD CONSTRAINT FK_CFBDFA144BD2A4C0 FOREIGN KEY (report_id) REFERENCES report (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
