...
class Version031 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE audit_log_entry (id SERIAL NOT NULL, performed_by_user_id INT DEFAULT NULL, performed_by_user_name VARCHAR(150) NOT NULL, performed_by_user_email VARCHAR(150) NOT NULL, ip_address VARCHAR(15) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, action VARCHAR(15) NOT NULL, user_edited_id INT DEFAULT NULL, user_edited_name VARCHAR(150) DEFAULT NULL, user_edited_email VARCHAR(150) DEFAULT NULL, PRIMARY KEY(id))');
