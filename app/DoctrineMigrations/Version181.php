...
class Version181 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("UPDATE money_transaction SET category='anything-else-paid-out', description = rtrim('Accommodation costs - ' || description, '- '), meta = 'category accommodation-other -> anything-else migrated on {$today}' WHERE category= 'accommodation-other'; ");
