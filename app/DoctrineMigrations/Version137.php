...
class Version137 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE document (id SERIAL NOT NULL, report_id INT DEFAULT NULL, created_by INT DEFAULT NULL, local_filename VARCHAR(150) NOT NULL, uploaded_filename VARCHAR(150) DEFAULT NULL, storage_reference VARCHAR(150) DEFAULT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
