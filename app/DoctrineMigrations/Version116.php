 ...
 */
class Version116 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE casrec (id SERIAL NOT NULL, client_case_number VARCHAR(20) NOT NULL, client_lastname VARCHAR(50) NOT NULL, deputy_no VARCHAR(100) NOT NULL, deputy_lastname VARCHAR(100) DEFAULT NULL, deputy_postcode VARCHAR(10) DEFAULT NULL, type_of_report VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE report (id SERIAL NOT NULL, client_id INT DEFAULT NULL, type VARCHAR(3) NOT NULL, has_debts VARCHAR(5) DEFAULT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, submit_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, no_asset_to_add BOOLEAN DEFAULT \'false\', no_transfers_to_add BOOLEAN DEFAULT \'false\', reason_for_no_contacts TEXT DEFAULT NULL, reason_for_no_decisions TEXT DEFAULT NULL, submitted BOOLEAN DEFAULT NULL, report_seen BOOLEAN DEFAULT \'true\' NOT NULL, agreed_behalf_deputy VARCHAR(50) DEFAULT NULL, agreed_behalf_deputy_explanation TEXT DEFAULT NULL, metadata TEXT DEFAULT NULL, action_more_info VARCHAR(3) DEFAULT NULL, action_more_info_details TEXT DEFAULT NULL, paid_for_anything VARCHAR(3) DEFAULT NULL, gifts_exist VARCHAR(3) DEFAULT NULL, money_transactions_short_in_exist VARCHAR(3) DEFAULT NULL, money_transactions_short_out_exist VARCHAR(3) DEFAULT NULL, balance_mismatch_explanation TEXT DEFAULT NULL, PRIMARY KEY(id))');
