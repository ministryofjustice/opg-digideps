...
class Version152 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE action DROP CONSTRAINT IF EXISTS fk_47cc8c924bd2a4c0');
        $this->addSql('ALTER TABLE action DROP CONSTRAINT IF EXISTS fk_281efba84bd2a4c0');
        ...
        $this->addSql('ALTER TABLE odr_expense DROP CONSTRAINT IF EXISTS fk_2d3a8da67ce4b994');
        $this->addSql('ALTER TABLE odr_expense DROP CONSTRAINT IF EXISTS FK_92A22FF97CE4B994');
