...
class Version154 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE note DROP CONSTRAINT IF EXISTS fk_cfbdfa144bd2a4c0');
        $this->addSql('ALTER TABLE note DROP CONSTRAINT IF EXISTS FK_CFBDFA1465CF370E');
        $this->addSql('ALTER TABLE note DROP CONSTRAINT IF EXISTS FK_CFBDFA1419EB6921');
        $this->addSql('ALTER TABLE note DROP CONSTRAINT IF EXISTS FK_CFBDFA1465CF370E');
