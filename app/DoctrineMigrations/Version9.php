...
class Version9 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE client ALTER court_date TYPE DATE');
        $this->addSql('ALTER TABLE asset ALTER p_date TYPE DATE');
        $this->addSql('ALTER TABLE report ALTER start_date TYPE DATE');
        $this->addSql('ALTER TABLE report ALTER end_date TYPE DATE');
        $this->addSql('ALTER TABLE decision ALTER d_date TYPE DATE');
        $this->addSql('ALTER TABLE account ALTER opening_date TYPE DATE');
        $this->addSql('ALTER TABLE account ALTER closing_date TYPE DATE');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE decision ALTER d_date TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE asset ALTER p_date TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE account ALTER opening_date TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE account ALTER closing_date TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE report ALTER start_date TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE report ALTER end_date TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE client ALTER court_date TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
    }
}
