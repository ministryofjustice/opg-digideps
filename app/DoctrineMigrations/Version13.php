 ...
 */
class Version13 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dd_user ALTER active SET DEFAULT \'false\'');
        $this->addSql('ALTER TABLE dd_user RENAME COLUMN password_salt TO salt');
        $this->addSql('ALTER TABLE role ADD role VARCHAR(50) DEFAULT NULL');
        $this->addSql('ALTER TABLE role ALTER name SET NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE role ALTER name DROP NOT NULL');
        $this->addSql('ALTER TABLE dd_user ALTER active DROP DEFAULT');
        $this->addSql('ALTER TABLE dd_user RENAME COLUMN salt TO password_salt');
    }
}
