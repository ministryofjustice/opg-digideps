...
class Version058 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE money_transfer (id INT NOT NULL, from_account_id INT DEFAULT NULL, to_account_id INT DEFAULT NULL, amount NUMERIC(10, 0) NOT NULL, PRIMARY KEY(id))');
