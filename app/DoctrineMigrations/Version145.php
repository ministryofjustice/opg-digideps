...
class Version145 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE lifestyle (id SERIAL NOT NULL, report_id INT DEFAULT NULL, care_appointments VARCHAR(255) DEFAULT NULL, does_client_undertake_social_activities VARCHAR(4) NOT NULL, activity_details VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
