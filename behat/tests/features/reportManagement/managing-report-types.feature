Feature: Managing report types
  ...
  Scenario: Changing the report type for an active lay report
    ...
    When a case manager changes the report type for the "2018" to "2019" report between "DeputyX" and "95463425" to "103"
  ...
  Scenario: Changing the report type for an active organisation based report
    ...
    When a case manager changes the report type for the "2018" to "2019" report between "DeputyZ" and "95432265" to "103-5"
  ...
  Scenario: Changing the report type for a submitted report
    ...
    When a case manager changes the report type for the "2018" to "2019" report between "DeputyY" and "95432490" to "103-6"
