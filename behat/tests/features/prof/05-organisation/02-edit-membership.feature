Feature: Users can edit members of their organisation
  ...
  @prof
  Scenario: Org domains: Users can add users from other domains
    ...
    When I fill in the following:
      | organisation_member_firstname  | Yvonne                               |
      | organisation_member_lastname   | Lacasse                              |
      | organisation_member_email      | y.lacasse@abc-solicitors.example.com |
      | organisation_member_roleName_1 | ROLE_PROF_TEAM_MEMBER                |
    And I press "Save"
    Then the URL should match "/org/settings/organisation/\d+"
    And I should see "Yvonne Lacasse"
    And I should see "y.lacasse@abc-solicitors.example.com"
    And the last email should have been sent to "y.lacasse@abc-solicitors.example.com"
    And the last email should contain "Activate your account"
    And the last email should contain "/user/activate"

  @prof
  Scenario: Public domains: Can add users to their organisation
    ...
    And I am logged in as "jo.brown@example.com" with password "Abcd1234"
    When I go to "/org/settings/organisation"
    And I follow "Add user"
    And I fill in the following:
