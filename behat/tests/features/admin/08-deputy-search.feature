Feature: Deputy search
  ...
  Scenario: Search broadly across all deputy roles, excluding clients
    ...
    And I search for a deputy with the term "User-2"
  ...
  Scenario: Search broadly across deputy by a role, excluding clients
    Given I am logged in to admin as "admin@publicguardian.gov.uk" with password "Abcd1234"
    And I search for a deputy with the term "Manager1" and filter role by "ROLE_PA_NAMED"
    Then I should see "Found 0 users"
    When I search for a deputy with the term "Manager1" and filter role by "ROLE_CASE_MANAGER"
  ...
  Scenario: Search broadly across all deputy roles, including clients
    Given I am logged in to admin as "admin@publicguardian.gov.uk" with password "Abcd1234"
    And I search for a deputy with the term "103-client"
    Then I should see "Found 0 users"
    And I should not see "LAY Deputy 103 User"
    When I search for a deputy with the term "103-client" and include clients
    Then I should see "Found 1 users"
  ...
  Scenario: Search broadly across deputy by a role, including clients
    Given I am logged in to admin as "admin@publicguardian.gov.uk" with password "Abcd1234"
    When I search for a deputy with the term "103-6-client" and include clients
    Then I should see "Found 3 users"
    When I search for a deputy with the term "103-6-client" and filter role by "ROLE_PA_NAMED" and include clients
    Then I should see "Found 1 users"

  @admin @admin-search @deputy-search
  Scenario: Search exact name match across all deputy roles, excluding clients
    Given I am logged in to admin as "admin@publicguardian.gov.uk" with password "Abcd1234"
    And I search for a deputy with the term "Admin User"
  ...
  Scenario: Search exact name match across all deputy roles, including clients
    Given I am logged in to admin as "admin@publicguardian.gov.uk" with password "Abcd1234"
    And I search for a deputy with the term "john 104-client"
    Then I should see "Found 0 users"
    When I search for a deputy with the term "john 104-client" and include clients
    Then I should see "Found 1 users"
