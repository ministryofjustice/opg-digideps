...
class ReportValidatorTest extends MockeryTestCase
{
    ...
    public function sectionProvidor()
    {
        return [
                ...
                [Report::TYPE_102, MoneyInShortController::class, true],
                [Report::TYPE_102, MoneyOutController::class, true],
                [Report::TYPE_102, MoneyOutShortController::class, true],
                ...
                [Report::TYPE_103, MoneyInController::class, true],
                [Report::TYPE_103, MoneyInShortController::class, true],
                [Report::TYPE_103, MoneyOutController::class, true],
                [Report::TYPE_103, MoneyOutShortController::class, true],
                [Report::TYPE_103, MoneyTransferController::class, true],
                ...
                [Report::TYPE_104, BalanceController::class, true],
