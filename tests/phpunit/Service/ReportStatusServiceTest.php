...
class ReportStatusServiceTest extends \PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        $this->translator = m::mock('Symfony\Component\Translation\TranslatorInterface')
            ...
            ->shouldReceive('trans')->with('decision')->andReturn("Decision")
            ->shouldReceive('trans')->with('decisions')->andReturn("Decisions")
            ->shouldReceive('trans')->with('nodecisions')->andReturn("No decisions")
            ->shouldReceive('trans')->with('contact')->andReturn("Contact")
            ->shouldReceive('trans')->with('contacts')->andReturn("Contacts")
            ->shouldReceive('trans')->with('account')->andReturn("Account")
            ->shouldReceive('trans')->with('accounts')->andReturn("Accounts")
            ->shouldReceive('trans')->with('asset')->andReturn("Asset")
            ->shouldReceive('trans')->with('assets')->andReturn("Assets")
            ->shouldReceive('trans')->with('noassets')->andReturn("No assets")
            ->shouldReceive('trans')->with('nocontacts')->andReturn("No contacts")
            ->shouldReceive('trans')->with('notstarted')->andReturn("Not started")
            ->shouldReceive('trans')->with('finished')->andReturn("Finished")
            ->getMock();
