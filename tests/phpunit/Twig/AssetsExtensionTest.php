...
class ReportStatusService extends \PHPUnit_Framework_TestCase {
    ...
    private function clean() {
        if (file_exists('/tmp/test/app')) rmdir('/tmp/test/app');
        if (file_exists('/tmp/test/web/assets/1234')) rmdir('/tmp/test/web/assets/1234');
        if (file_exists('/tmp/test/web/assets/1234')) rmdir('/tmp/test/web/assets');
        if (file_exists('/tmp/test/web/assets/1234')) rmdir('/tmp/test/web');
        if (file_exists('/tmp/test/web/assets/1234')) rmdir('/tmp/test');
    }
