Feature: browser - accounts
    ...
    Scenario: add account
        ...
        Then I fill in "transactions_transactionsIn_0_amount_0" with "100"
        And I tab to the next field
        And I pause
        And I save the page as "moneyin-2"
        Then I should see "Saved" in the section title info panel
        And the "transactions_transactionsIn_0_amount_0" field should contain "100.00"
        ...
        Then I fill in "transactions_transactionsOut_13_amount_0" with "101"
        And I tab to the next field
        And I pause
        Then I should see "Saved" in the section title info panel
        And I save the page as "moneyout-2"
        And the "transactions_transactionsOut_13_amount_0" field should contain "101.00"
        Then I follow "account-moneyout"
        And the "transactions_transactionsOut_13_amount_0" field should contain "101.00"
        ...
        Then I follow "account-moneyout"
        And I click on "accommodation"
        Then I fill in "transactions_transactionsOut_13_amount_0" with "100"
        And I tab to the next field
        And I pause
        Then I follow "account-balance"
