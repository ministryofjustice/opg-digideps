Feature: VisitsCare Data entry
    ...
    Scenario: Lives with client
        ...
        And I fill in the visits and care form with the following:
        ...
        Then the checkbox "visits_care_doYouLiveWithClient_0" should be checked
    ...
    Scenario: Does not live with client
        ...
        And I save the page as "visits-care-dataentry"
    ...
    Scenario: Client does not receive care
        ...
        When I follow "overview-button"
        And I follow "edit-visits_care"
        Then the checkbox "visits_care_doesClientReceivePaidCare_1" should be checked
    ...
    Scenario: Client does receive care
        ...
        When I follow "overview-button"
        And I follow "edit-visits_care"
        Then the checkbox "visits_care_doesClientReceivePaidCare_0" should be checked
        And the checkbox "visits_care_howIsCareFunded_0" should be checked
    ...
    Scenario: Who is doing the caring?
        ...
        When I follow "overview-button"
        And I follow "edit-visits_care"
        And the "visits_care_whoIsDoingTheCaring" field should contain "Fred Jones"
    ...
    Scenario: Client has care plan
        ...
        When I follow "overview-button"
        And I follow "edit-visits_care"
        Then the checkbox "visits_care_doesClientHaveACarePlan_0" should be checked
        And the "visits_care_whenWasCarePlanLastReviewed_month" field should contain "01"
        And the "visits_care_whenWasCarePlanLastReviewed_year" field should contain "2016"
    ...
    Scenario: Client does not have care plan
        ...
        When I follow "overview-button"
        And I follow "edit-visits_care"
        Then the checkbox "visits_care_doesClientHaveACarePlan_1" should be checked
