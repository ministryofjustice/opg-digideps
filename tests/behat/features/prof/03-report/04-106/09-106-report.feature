Feature: PROF Deputy fees and expenses (106)

    Scenario: PROF deputy fees
...
#        And I save the application status into "prof-fees-completed"
#
#    Scenario: PROF fees outside practice
#        Given I load the application status from "prof-fees-completed"
#        And I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
#        And I click on "pa-report-open" in the "client-01000014" region
#        And I click on "edit-pa_fee_expense"
