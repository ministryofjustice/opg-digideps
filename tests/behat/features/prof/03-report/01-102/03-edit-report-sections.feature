Feature: PROF user edits report sections

  Scenario: PROF 102 deputy expenses (No fees exist)
  ...
  Scenario: PROF 102 add current account
    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
    And I click on "pa-report-open" in the "client-01000014" region
  ...
  Scenario: PROF 102 add postoffice account (no sort code, no bank name)
    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
    And I click on "pa-report-open" in the "client-01000014" region
  ...
  Scenario: PROF 102 add no sortcode account (still requires bank name)
    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
    And I click on "pa-report-open" in the "client-01000014" region
    And I click on "edit-bank_accounts, add"
    # step 1
  ...
  Scenario: PROF 102 deletes bank account
    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
  ...
  Scenario: PROF 102 Report should be submittable
    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
    And I click on "pa-report-open" in the "client-01000014" region
