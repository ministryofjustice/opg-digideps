Feature: PROF user edits common report sections common to ALL report types
  ...
  @102 @103-5 @104
  Scenario: PROF 102 user edit decisions section
...
#
#  @102 @103-5 @104
#  Scenario: PROF 102 saves a contact
...
#
#  @102 @103-5 @104
#  Scenario: PROF 102 visits and care steps
#    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
#    And I click on "pa-report-open" in the "client-01000014" region
...
#
#  @102 @103-5 @104
#  Scenario: PROF 102 report actions
#    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
#    And I click on "pa-report-open" in the "client-01000014" region
...
#
#  @102 @103-5 @104
#  Scenario: PROF 102 any other info
#    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
#    And I click on "pa-report-open" in the "client-01000014" region
...
#
#  @102 @103-5 @104
#  Scenario: PROF adds documents to 102
#    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
#    And I click on "pa-report-open" in the "client-01000014" region
...
#
#  @102 @103-5 @104
#  Scenario: PROF deletes document from 102
#    Given I am logged in as "behat-prof1@publicguardian.gsi.gov.uk" with password "Abcd1234"
#    And I click on "pa-report-open" in the "client-01000014" region
