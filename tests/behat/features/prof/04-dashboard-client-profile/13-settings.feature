...
#    And I should see "behat-prof1@publicguardian.gsi.gov.uk" in the "profile-email" region
...
#      | profile_email      | behat-prof1@publicguardian.gsi.gov.uk   |
...
#      | profile_email      | behat-prof1-admin@publicguardian.gsi.gov.uk |
...
#    And I should see "behat-prof1-admin@publicguardian.gsi.gov.uk" in the "profile-email" region
...
#      | profile_email            | behat-prof3-team-member@publicguardian.gsi.gov.uk |
...
#    And I should see "behat-prof3-team-member@publicguardian.gsi.gov.uk" in the "profile-email" region
