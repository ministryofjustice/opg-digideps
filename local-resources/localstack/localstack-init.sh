...
awslocal secretsmanager create-secret --name "local/smoke-test-variables" --secret-string "{\"admin_user\":\"super-admin@publicguardian.gov.uk\",\"admin_password\":\"DigidepsPass1234\",\"client\":\"64444001\",\"deputy_user\":\"lay-opg102-user-1@publicguardian.gov.uk\",\"deputy_password\":\"DigidepsPass1234\"}"
