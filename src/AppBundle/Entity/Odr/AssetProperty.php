...
class AssetProperty extends Asset
{
    ...
    /**
     * @Assert\NotBlank(message="odr.asset.property.address.notBlank", groups={"property-address"})
     * @Assert\Length( max=200, maxMessage="odr.asset.property.address.maxMessage", groups={"property-address"})
     * @JMS\Type("string")
     *
     * @var string
     */
    ...
    /**
     * @Assert\Length( max=75, maxMessage="odr.asset.property.county.maxMessage", groups={"property-address"})
     * @JMS\Type("string")
     *
     * @var string
     */
    ...
    /**
     * @Assert\NotBlank(message="odr.asset.property.postcode.notBlank", groups={"property-address"})
     * @Assert\Length(max=10, maxMessage= "odr.asset.property.postcode.maxMessage", groups={"property-address"})
     * @JMS\Type("string")
     *
     * @var string
     */
    ...
    /**
     * @Assert\NotBlank(message="odr.asset.property.occupants.notBlank", groups={"property-occupants"})
    ...
    /**
     * @Assert\NotBlank(message="odr.asset.property.isSubjectToEquityRelease.notBlank", groups={"property-subject-equity-release"})
     * @JMS\Type("string")
     */
    private $isSubjectToEquityRelease;

    /**
     * @Assert\NotBlank(message="odr.asset.property.hasMortgage.notBlank", groups={"property-mortgage"})
     *
     * @var string
     * @JMS\Type("string")
     */
     ...
     * @Assert\Range(max=100000000000, maxMessage = "odr.asset.property.mortgageOutstandingAmount.outOfRange", groups={"property-mortgage-outstanding-amount"})
     * 
     * @var string
     * @JMS\Type("integer")
     */
    ...
    /**
     * @Assert\NotBlank(message="odr.asset.property.rentAgreementEndDate.notBlank", groups={"property-rent-agree-date"})
     *
     * @var \DateTime
     ...
     * @Assert\Range(max=10000000000, maxMessage = "odr.asset.property.rentIncomeMonth.outOfRange", groups={"property-rent-income-month"})
     * 
     * @var float
     * @JMS\Type("float")
     */
