...
class User implements AdvancedUserInterface
{
     ...
     * @Assert\NotBlank( message="user.address1.notBlank", groups={"user_details_full", "user_details_pa"} )
     ...
     * @JMS\Type("string")
     * @JMS\Groups({"user_details_full", "user_details_pa"})
     * @Assert\NotBlank( message="user.addressPostcode.notBlank", groups={"user_details_full", "user_details_pa"} )
     ...
     * @JMS\Type("string")
     * @JMS\Groups({"user_details_full", "user_details_pa"})
     * @Assert\NotBlank( message="user.addressCountry.notBlank", groups={"user_details_full", "user_details_pa"} )
     *
     * @var string
     */
