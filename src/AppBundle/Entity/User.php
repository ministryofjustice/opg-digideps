...
class User implements AdvancedUserInterface
{
     ...
     * @Assert\NotBlank( message="user.firstname.notBlankOtherUser", groups={"pa_team_add", "user_details_pa"} )
     ...
     * @Assert\NotBlank(message="user.lastname.notBlankOtherUser", groups={"pa_team_add", "user_details_pa"} )
