...
trait DbTrait
{
    ...
    public static function iSaveTheApplicationStatusInto($status)
    {
        ...
        exec('echo "SET client_min_messages TO WARNING; truncate dd_user, dd_team, organisation, named_deputy, organisation_user, casrec, setting, user_team, client cascade;" > ' . $sqlFile);
