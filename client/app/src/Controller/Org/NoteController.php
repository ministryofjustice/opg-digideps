...
class NoteController extends AbstractController
{
     ...
     * @throws \Exception
     */
    #[Route(path: '{noteId}/edit', name: 'edit_note')]
    #[Template('@App/Org/ClientProfile/editNote.html.twig')]
    public function editAction(Request $request, string $noteId): RedirectResponse|array
    {
        /** @var Note $note */
     ...
     * @throws \Exception
     */
    #[Route(path: '{noteId}/delete', name: 'delete_note')]
    #[Template('@App/Common/confirmDelete.html.twig')]
    public function deleteConfirmAction(Request $request, string $noteId, LoggerInterface $logger): RedirectResponse|array
    {
        /** @var Note $note */
        $note = $this->getNote($noteId);
     ...
     */
    private function getNote(string $noteId): mixed
    {
