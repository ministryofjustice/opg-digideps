...
class FixtureController extends AbstractController
{
    ...
    public function retrieveFormData($form, $request): array
    {
        ...
        $deputyEmail = $request->query->get('deputy-email', sprintf('original-%s-deputy-%s@fixture.com', isnull($submitted['deputyType']) ? null : strtolower($submitted['deputyType']), mt_rand(1000, 9999)));
