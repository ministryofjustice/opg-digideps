...
class FixtureController extends AbstractController
{
    ...
    public function retrieveFormData($form, $request): array
    {
        ...
        $deputyEmail = $request->query->get('deputy-email', sprintf('original-%s-deputy-%s@fixture.com', null !== $submitted['deputyType'] ? strtolower($submitted['deputyType']) : null, mt_rand(1000, 9999)));
