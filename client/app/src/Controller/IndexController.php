...
class IndexController extends AbstractController
{
     ...
     * Session logic for login is now in LoginFormAuthenticator as of Symfony 5.4.
     */
    #[Route(path: '/login-sso', name: 'login')]
    #[Template('@App/Index/login-sso.html.twig')]
    public function loginSSOAction(Request $request, AuthenticationUtils $authenticationUtils): ?Response
    {
        $form = $this->createForm(Form\LoginType::class);
        $vars = [
            'isAdmin' => true,
        ...
        return $this->render('@App/Index/login-sso.html.twig', [
            'form' => $form->createView(),
            'serviceNotificationContent' => $snSetting->isEnabled() ? $snSetting->getContent() : null,
            'notPrimaryAccount' => $request->query->get('notPrimaryAccount'),
        ] + $vars);
