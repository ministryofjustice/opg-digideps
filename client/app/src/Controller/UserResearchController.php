...
class UserResearchController extends AbstractController
{
    ...
    #[Route(path: '/ndr/{ndrId}/post_submission_user_research', name: 'ndr_post_submission_user_research')]
    #[Template('@App/UserResearch/postSubmissionUserResearch.html.twig')]
    public function postSubmissionUserResearch(Request $request, ?int $reportId = null, ?int $ndrId = null): RedirectResponse|array
    {
    ...
    #[Route(path: '/ndr/{ndrId}/post_submission_user_research/submitted', name: 'ndr_user_research_submitted')]
    #[Template('@App/UserResearch/userResearchSubmitted.html.twig')]
    public function userResearchSubmitted(?int $reportId = null, ?int $ndrId = null): array
    {
