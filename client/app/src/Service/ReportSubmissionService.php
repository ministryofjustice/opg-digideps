...
class ReportSubmissionService
{
    ...
    {
        $html = $devPreview ? $this->templating->render('@App/Report/Rendered/standalone.html.twig', [
            'report' => $report,
            'review' => new ReportReviewViews($report, $this->translator),
            'showSummary' => $showSummary,
        ]) : $this->templating->render('@App/Report/Formatted/formatted_standalone.html.twig', [
            'report' => $report,
            'showSummary' => $showSummary,
        ]);
