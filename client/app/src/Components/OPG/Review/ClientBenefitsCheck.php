...
final class ClientBenefitsCheck
{
    ...
    private function makeList(?ReportClientBenefitsCheck $clientBenefitsCheck): SummaryList
    {
        ...
        $builder->addItem($this->text['benefitsCheck'], $clientBenefitsCheck === null ? $this->text['notEntered'] : $this->translate("form.whenLastChecked.choices.{$clientBenefitsCheck->getWhenLastCheckedEntitlement()}"));
        ...
        $builder->addItem($this->text['doOthersReceiveMoney'], $clientBenefitsCheck === null ? $this->text['notEntered'] : $this->translate("form.moneyOnClientsBehalf.choices.{$clientBenefitsCheck->getDoOthersReceiveMoneyOnClientsBehalf()}"));
