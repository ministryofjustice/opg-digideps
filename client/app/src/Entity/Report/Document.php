...
class Document implements DocumentInterface, SynchronisableInterface
{
    ...
    public function isValidForReport(ExecutionContextInterface $context): void
    {
        ...
        $fileOriginalName = FileNameFixer::removeUnusualCharacters($this->getFile()->getClientOriginalName());
        $fileOriginalName = FileNameFixer::removeWhiteSpaceBeforeFileExtension($fileOriginalName);
