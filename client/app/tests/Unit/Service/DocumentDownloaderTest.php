...
class DocumentDownloaderTest extends TestCase
{
    ...
    private ReportSubmissionService&MockObject $reportSubmissionService;
    private DocumentsZipFileCreator&MockObject $zipFileCreator;
    ...
    public function testZipDownloadedDocuments(): void
    {
        ...
        $this->zipFileCreator->expects(self::once())
            ...
            ->with($retrievedDocs)
            ->willReturn([new \ZipArchive()]);

        $this->zipFileCreator->method('createMultiZipFile')->willReturn('some-file.zip');
