...
class MimeTypeAndExtensionCheckerTest extends KernelTestCase
{
    ...
    public function fileProvider()
    {
        return [
            ...
            'matching JPG' => ['tests/Unit/TestData/jpg-file.jpg', 'jpg-file.jpg', true],
            'matching PNG' => ['tests/Unit/TestData/png-file.png', 'png-file.png', true],
            'matching PDF' => ['tests/Unit/TestData/pdf-file.pdf', 'pdf-file.pdf', true],
            'not matching JPEG' => ['tests/Unit/TestData/png-file.jpeg', 'png-file.jpeg', false],
            'not matching PNG' => ['tests/Unit/TestData/pdf-file.png', 'pdf-file.png', false],
            'not matching PDF' => ['tests/Unit/TestData/jpeg-file.pdf', 'jpeg-file.pdf', false],
        ];
    }
}
