...
class FileNameManipulationTest extends KernelTestCase
{
    ...
    public function missingExtensionFilesProvider()
    {
        return [
            ...
            'pdf' => ['tests/Unit/TestData/good-pdf', 'good-pdf', 'good-pdf.pdf'],
            'png' => ['tests/Unit/TestData/good-png', 'good-png', 'good-png.png'],
            'Already has an extension' => ['tests/Unit/TestData/good-jpeg.jpeg', 'good-jpeg.jpeg', 'good-jpeg.jpeg'],
        ];
    }
    ...
    {
        return [
            'file extension is lowercased' => ['/tests/Unit/TestData/upperCaseFileExt.PNG', 'upperCaseFileExt.PNG', 'upperCaseFileExt.png'],
            'file extension remains the same' => ['/tests/Unit/TestData/good-jpeg.jpeg', 'good-jpeg.jpeg', 'good-jpeg.jpeg'],
            'file is returned because of missing extension' => ['/tests/Unit/TestData/good-jpeg', 'good-jpeg', 'good-jpeg'],
        ];
    }
}
