...
trait ReportMoreInfoTrait
{
     ...
     * @Assert\NotBlank(message="ndr.action.actionMoreInfo.notBlank", groups={"more-info"})
     */
     ...
     * @JMS\Type("string")
     * @JMS\Groups({"more-info"})
     * @Assert\NotBlank(message="ndr.action.actionMoreInfoDetails.notBlank", groups={"more-info-details"})
     */
