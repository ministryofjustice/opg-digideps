...
locals {
  ...
  main_cert    = local.old_prod_dns == 1 ? aws_acm_certificate_validation.wildcard[0].certificate_arn : ""
  new_cert     = local.old_prod_dns == 1 ? aws_acm_certificate_validation.complete_deputy_report_wildcard[0].certificate_arn : ""
