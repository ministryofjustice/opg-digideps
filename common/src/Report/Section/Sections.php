...
final readonly class Sections implements \IteratorAggregate
{
    ...
    {
        $pfa = $type->courtOrderType === CourtOrderType::PFA || $type->courtOrderKind === CourtOrderKind::Hybrid;
        $hw = $type->courtOrderType === CourtOrderType::HW || $type->courtOrderKind === CourtOrderKind::Hybrid;
