...
{
    public function testGetIntegerOrDefault()
    {
    ...
    public function testGetFloatOrDefault()
    {
        $default = 55.0;
        $array = ['1', 'two' => 2, 'three' => 3.0];
        $validatingArray = new ValidatingArray($array);
    ...
    public function testGetStringOrDefault()
    {
        $default = 'DEFAULT';
        $array = ['1', 'two' => 2, 'three' => 3.0];
        $validatingArray = new ValidatingArray($array);
    ...
    public function testGetArrayOrDefault()
    {
        $default = ["88", "99"];
        $test = [1, 2, 3];
