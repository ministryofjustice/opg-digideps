...
class Report implements ReportInterface
{
    ...
    private static $reportTypes = [
        ...
        self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_HW_TYPE, self::PROF_COMBINED_LOW_ASSETS, self::TYPE_102_4_5,
    ];
    ...
    public static function getSectionsSettings()
    {
        $allReports = [
            ...
            self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_HW_TYPE, self::PROF_COMBINED_LOW_ASSETS, self::TYPE_102_4_5, // Prof
        ];
        $pfaAndCombined = [
            ...
            self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_COMBINED_LOW_ASSETS, self::TYPE_102_4_5, // Prof
        ];
        $hw = [
            ...
            self::PROF_HW_TYPE, self::PROF_COMBINED_LOW_ASSETS, self::TYPE_102_4_5, // PA
        ];

        $allProfReports = [
            self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_HW_TYPE,
            self::PROF_COMBINED_LOW_ASSETS, self::TYPE_102_4_5,
        ];
        ...
        return [
            ...
            self::SECTION_PROF_CURRENT_FEES => self::ENABLE_FEE_SECTIONS ? [
                self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_COMBINED_LOW_ASSETS, self::TYPE_102_4_5, // Prof except 104-6
            ] : [],
    ...
    {
        return in_array($this->getType(), [self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_HW_TYPE, self::TYPE_102_4_5, self::PROF_COMBINED_LOW_ASSETS]);
    }
