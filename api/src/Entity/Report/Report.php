...
class Report implements ReportInterface
{
    ...
    private static $reportTypes = [
        ...
        self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_HW_TYPE, self::TYPE_103_4_5, self::TYPE_102_4_5,
    ];
    ...
    public static function getSectionsSettings()
    {
        $allReports = [
            ...
            self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_HW_TYPE, self::TYPE_103_4_5, self::TYPE_102_4_5, // Prof
        ];
        $pfaAndCombined = [
        ...
        $hw = [
            ...
            self::PROF_HW_TYPE, self::TYPE_103_4_5, self::TYPE_102_4_5, // PA
        ];
    ...
    {
        return in_array($this->getType(), [self::PROF_PFA_HIGH_ASSETS_TYPE, self::PROF_PFA_LOW_ASSETS_TYPE, self::PROF_HW_TYPE, self::TYPE_102_4_5, self::TYPE_103_4_5]);
    }
