...
trait FormFillingTrait
{
     ...
     * @param string      $value           field value to enter
     ...
     */
    public function fillInField(string $field, string $value, ?string $formSectionName = null, int $answerGroup = 0)
    {
        if ($formSectionName) {
     ...
     * @param string      $option          option value to choose
