...
class Version181 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE casrec (id SERIAL NOT NULL, client_case_number VARCHAR(20) NOT NULL, client_lastname VARCHAR(50) NOT NULL, deputy_no VARCHAR(100) NOT NULL, deputy_lastname VARCHAR(100) DEFAULT NULL, deputy_postcode VARCHAR(10) DEFAULT NULL, type_of_report VARCHAR(10) DEFAULT NULL, corref VARCHAR(10) DEFAULT NULL, other_columns TEXT DEFAULT NULL, uploaded_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, registration_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_logged_in TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, reports_submitted VARCHAR(4) DEFAULT NULL, last_report_submitted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, ndr_submitted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, reports_active VARCHAR(4) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX updated_at_idx ON casrec (updated_at)');
        $this->addSql('CREATE TABLE money_transaction (id SERIAL NOT NULL, report_id INT DEFAULT NULL, bank_account_id INT DEFAULT NULL, category VARCHAR(255) NOT NULL, amount NUMERIC(14, 2) NOT NULL, description TEXT DEFAULT NULL, meta TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE expense (id SERIAL NOT NULL, report_id INT DEFAULT NULL, bank_account_id INT DEFAULT NULL, explanation TEXT NOT NULL, amount NUMERIC(14, 2) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2D3A8DA64BD2A4C0 ON expense (report_id)');
        $this->addSql('CREATE INDEX IDX_2D3A8DA612CB990C ON expense (bank_account_id)');
        ...
        $this->addSql('CREATE TABLE gift (id SERIAL NOT NULL, report_id INT DEFAULT NULL, bank_account_id INT DEFAULT NULL, explanation TEXT NOT NULL, amount NUMERIC(14, 2) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE report_submission (id SERIAL NOT NULL, report_id INT DEFAULT NULL, ndr_id INT DEFAULT NULL, archived_by INT DEFAULT NULL, created_by INT DEFAULT NULL, downloadable BOOLEAN DEFAULT \'true\' NOT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE report (id SERIAL NOT NULL, client_id INT DEFAULT NULL, submitted_by INT DEFAULT NULL, type VARCHAR(10) NOT NULL, start_date DATE DEFAULT NULL, due_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, submit_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, un_submit_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_edit TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, submitted BOOLEAN DEFAULT NULL, report_seen BOOLEAN DEFAULT \'true\' NOT NULL, agreed_behalf_deputy VARCHAR(50) DEFAULT NULL, agreed_behalf_deputy_explanation TEXT DEFAULT NULL, wish_to_provide_documentation VARCHAR(255) DEFAULT NULL, current_prof_payments_received VARCHAR(255) DEFAULT NULL, previous_prof_fees_estimate_given VARCHAR(3) DEFAULT NULL, prof_fees_estimate_scco_reason TEXT DEFAULT NULL, unsubmitted_sections_list TEXT DEFAULT NULL, no_asset_to_add BOOLEAN DEFAULT \'false\', balance_mismatch_explanation TEXT DEFAULT NULL, reason_for_no_contacts TEXT DEFAULT NULL, reason_for_no_decisions TEXT DEFAULT NULL, reason_for_no_fees TEXT DEFAULT NULL, paid_for_anything VARCHAR(3) DEFAULT NULL, gifts_exist VARCHAR(3) DEFAULT NULL, money_transactions_short_in_exist VARCHAR(3) DEFAULT NULL, money_transactions_short_out_exist VARCHAR(3) DEFAULT NULL, no_transfers_to_add BOOLEAN DEFAULT \'false\', action_more_info VARCHAR(3) DEFAULT NULL, action_more_info_details TEXT DEFAULT NULL, has_debts VARCHAR(5) DEFAULT NULL, debt_management TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE money_transaction ADD CONSTRAINT FK_D21254E212CB990C FOREIGN KEY (bank_account_id) REFERENCES account (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE expense ADD CONSTRAINT FK_2D3A8DA612CB990C FOREIGN KEY (bank_account_id) REFERENCES account (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE gift ADD CONSTRAINT FK_A47C990D12CB990C FOREIGN KEY (bank_account_id) REFERENCES account (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
