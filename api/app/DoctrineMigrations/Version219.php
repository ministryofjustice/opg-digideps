...
final class Version219 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE named_deputy (id SERIAL NOT NULL, deputy_no VARCHAR(15) NOT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, email1 VARCHAR(60) NOT NULL, email2 VARCHAR(60) DEFAULT NULL, email3 VARCHAR(60) DEFAULT NULL, dep_addr_no INT DEFAULT NULL, PRIMARY KEY(id))');
