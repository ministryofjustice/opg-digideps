...
final class Version320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE report_cleanup_problem (id INT NOT NULL, client_id INT DEFAULT NULL, report_id INT DEFAULT NULL, order_id INT DEFAULT NULL, problem INT NOT NULL, PRIMARY KEY(id))');
    }
