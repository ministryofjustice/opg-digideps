...
final class Version308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE court_order ADD order_kind VARCHAR(6) NULL');
        ...
        $this->addSql('ALTER TABLE court_order ADD order_report_type VARCHAR(6) NULL');
        ...
        $this->addSql('ALTER TABLE court_order ALTER order_report_type SET NOT NULL');
