...
class PreRegistrationFactory
{
    ...
    private function convertDtoToArray(LayDeputyshipDto $dto): array
    {
        return [
            ...
            'ClientPostcode' => !empty(trim($dto->getClientPostcode())) ? trim($dto->getClientPostcode()) : $dto->getClientPostcode(),
            ...
            'DeputyPostcode' => !empty(trim($dto->getDeputyPostcode())) ? trim($dto->getDeputyPostcode()) : $dto->getDeputyPostcode(),
