...
class LayPreRegistrationDto
{
    ...
    public function setCaseNumber(string $caseNumber): LayPreRegistrationDto
    {
    ...
    public function setClientSurname($clientSurname): LayPreRegistrationDto
    {
    ...
    public function setDeputyUid(string $deputyUid): LayPreRegistrationDto
    {
    ...
    public function setDeputyFirstname(string $deputyFirstname): LayPreRegistrationDto
    {
    ...
    public function setDeputySurname(string $deputySurname): LayPreRegistrationDto
    {
    ...
    public function setDeputyPostcode(string $deputyPostcode): LayPreRegistrationDto
    {
    ...
    public function setTypeOfReport(string $typeOfReport): LayPreRegistrationDto
    {
    ...
    public function setIsNdrEnabled(bool $isNdrEnabled): LayPreRegistrationDto
    {
    ...
    public function setCourtOrderDate(\DateTime $courtOrderDate): LayPreRegistrationDto
    {
    ...
    public function setDeputyAddress1(?string $deputyAddress1): LayPreRegistrationDto
    {
    ...
    public function setDeputyAddress2(?string $deputyAddress2): LayPreRegistrationDto
    {
    ...
    public function setDeputyAddress3(?string $deputyAddress3): LayPreRegistrationDto
    {
    ...
    public function setDeputyAddress4(?string $deputyAddress4): LayPreRegistrationDto
    {
    ...
    public function setDeputyAddress5(?string $deputyAddress5): LayPreRegistrationDto
    {
    ...
    public function setIsCoDeputy(?bool $isCoDeputy): LayPreRegistrationDto
    {
    ...
    public function setCourtOrderType(?string $courtOrderType): LayPreRegistrationDto
    {
    ...
    public function setHybrid(?string $hybrid): LayPreRegistrationDto
    {
        $this->hybrid = $hybrid;
    ...
    public function setClientFirstname(?string $clientFirstname): LayPreRegistrationDto
    {
    ...
    public function setClientAddress1(?string $clientAddress1): LayPreRegistrationDto
    {
    ...
    public function setClientAddress2(?string $clientAddress2): LayPreRegistrationDto
    {
    ...
    public function setClientAddress3(?string $clientAddress3): LayPreRegistrationDto
    {
    ...
    public function setClientAddress4(?string $clientAddress4): LayPreRegistrationDto
    {
    ...
    public function setClientAddress5(?string $clientAddress5): LayPreRegistrationDto
    {
    ...
    public function setClientPostcode(?string $clientPostcode): LayPreRegistrationDto
    {
