...
class PreRegistrationFactory
{
    ...
    public function create(array $data): PreRegistration
    {
        ...
        $dto = (new LayPreRegistrationDto())
            ...
            ->setClientAddress1($data['clientAddress1'] ?? 'Victoria Park')
            ->setClientAddress2($data['clientAddress2'] ?? 'Fakeville')
            ->setClientAddress3($data['clientAddress3'] ?? 'Pretendham')
            ->setClientAddress4($data['clientAddress4'] ?? null)
            ->setClientAddress5($data['clientAddress5'] ?? null)
            ->setClientPostcode($data['clientPostCode'] ?? 'SW1')
