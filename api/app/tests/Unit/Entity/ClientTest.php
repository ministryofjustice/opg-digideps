...
final class ClientTest extends TestCase
{
    ...
    public function testGetExpectedStartDateNullCourtDate(): void
    {
    ...
    public function testGetExpectedEndDateNullCourtDate(): void
    {
        $this->object->setCourtDate(null);
        $this->assertEquals(null, $this->object->getExpectedReportEndDate(2020));
    }

    public function testSetCaseNumberEnforcesLowercase(): void
    {
        $sut = new Client();
