...
final class ReportTest extends TestCase
{
    ...
    {
        $client = new Client();
        $report1 = new Report($this->makeCourtOrder($client), Report::PROF_COMBINED_LOW_ASSETS_TYPE, new \DateTime('2023-01-01'), new \DateTime('2023-12-31'));
        $report1->setId(8);
        $report1->setSubmitted(true);
        $report1->setSubmitDate(new \DateTime('2024-01-01'));

        $report2 = new Report($this->makeCourtOrder($client), Report::LAY_PFA_HIGH_ASSETS_TYPE, new \DateTime('2025-01-01'), new \DateTime('2025-12-31'));
        $report2->setId(9);
