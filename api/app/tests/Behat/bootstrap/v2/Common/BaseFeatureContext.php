...
class BaseFeatureContext extends MinkContext
{
     ...
     */
    public function createProfAdminNotStarted(?BeforeScenarioScope $scenario = null, ?string $deputyEmail = null, ?string $caseNumber = null, ?int $deputyUid = null)
    {
     ...
     */
    public function createProfAdminCompleted(?BeforeScenarioScope $scenario = null, ?string $deputyEmail = null, ?string $caseNumber = null, ?int $deputyUid = null)
    {
     ...
     */
    public function createProfAdminSubmitted(?BeforeScenarioScope $scenario = null, ?string $deputyEmail = null, ?string $caseNumber = null, ?int $deputyUid = null)
    {
